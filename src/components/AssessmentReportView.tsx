...
import { Scale, CheckCircle2, AlertTriangle, XCircle, ShieldCheck, ArrowRight, BookOpen, FileText, HelpCircle, RefreshCw } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="font-serif text-xl sm:text-2xl font-bold text-stone-900">
          Rincian Evaluasi 4 Lapis Kelayakan Hukum:
        </h2>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-stone-200">
        ...
        >
          <span>Lanjut ke Panduan Alat Bukti (P-1 s.d. P-n)</span>
